{{--
    The Rowan Clinic mark. fill="currentColor" so it takes the colour of
    whatever it sits in — text-primary in the header, muted in the footer.

    The email version is a PNG (public/images/brand/mark-240.png), because mail
    clients strip SVG.
--}}
<svg {{ $attributes->merge(['class' => 'h-6 w-6']) }} viewBox="0 0 2048 2048" fill="none"
